...
<div class="top-wrap">
	...
	<div class="challenge-list-wrap">
		<ul class="list-box detail">
			<li>
				<div class="category"><%=compete.getCategory()%></div>
				<p class="tit ">탄소중립 실천을 위한 국민참여 확대· 활성화 아이디어</p>
				<p class="name">기획재정부
					
				</p>
				<p class="name">등록일 : <%=compete.getPost_time()%></p>
				
				<div class="info">
					<span class="price"><em>총상금</em> 
							
								<!-- 보상여부   -->
								<em><%=compete.getPrice()%></em>원
						 </span> 
						<span class="day"> 
											<em>참여신청/등록 마감일</em>
											<em>2022-08-19</em>
					...
					<span class="view"><em>조회수</em><em>1124</em></span>
				</div></li>
				
		</ul>
	</div>
			
			<tr><img src=<%=img_file%>><br></tr>
			<tr>
				<div class="challenge-list-wrap">
				<form action="SubmitCompete">
					<ul class="list-box detail">
						<br>
						<li><a href="http://localhost:10011/Test/img/competition/<%=compete.getNum()%>/<%=files[1]%>"><%=files[1] %></a></li>
			...
			<tr>
				<div class="challenge-list-wrap">
				<form method="post" action="SubmitCompete" enctype="multipart/form-data">
					<ul class="list-box detail">
						<br>
						<li><input type="file" name="submitfile" id="imgFileInput"></li>
