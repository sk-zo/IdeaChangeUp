...
PostDTO detail_post = (PostDTO)session.getAttribute("detail_post");
session.setAttribute("post", detail_post);%>
<script type="text/javascript">
	function search(frm) {
		frm.action="Search?index=<%=index%>";
		frm.submit();
		return true;
	}
...
<div class="content">
	<div class="sub_title"><h4>자료수정</h4></div>
	<div class="upload">
	<div id="uploadForms" class="file_step">
		...
		<div class="tb_list2" id="singleForm" style="border-bottom: none;">
			<form method="post" action="UpdatePost" style="margin:0">
				...
				<div id="singleFormButton">
					...
					<div class="btn_corm">
						<input type="submit" value="수정">  <input type="button" value="취소" onclick="return cancel(this.form)">  
					</div>
				</div>
		
				<div class="selectbox2" style="position:absolute;display:none;z-index:10; width:70px;" id="paperTypeDiv">
					<ul>
						<li><a href="javascript:void(0);" onclick="Upload.selectedPaperType('1');" class="c505050_s">학사</a></li>
						<li><a href="javascript:void(0);" onclick="Upload.selectedPaperType('2');" class="c505050_s">석사</a></li>
						<li><a href="javascript:void(0);" onclick="Upload.selectedPaperType('3');" class="c505050_s">박사</a></li>
					</ul>
				</div>
