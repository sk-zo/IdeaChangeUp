				...
				<div class="box"  style="position: relative;    width: 100%;    padding-right: 150px;    padding-left: 150px;">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">공모전 게시</h6>
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<input type="text" id="title" maxlength="200" name="title" class="up_in2" style="width:800px;">
							</td>
						</tr>
						<tr></tr>
						<tr></tr>
		                ...
		                <tr>
							<th>상금</th>
							<td>
								<input type="text" id="title" maxlength="200" name="price" class="up_in2" style="width:800px;">
							</td>
						</tr>
		                <tr>
							<th>마감일</th>
							<td>
								<input type="text" id="title" maxlength="200" name="deadline" class="up_in2" style="width:800px;">
							</td>
						</tr>
						<tr id="thumbnailDiv">
							<th>카테고리</th>
